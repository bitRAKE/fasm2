...
call "%ROOT%\fasm2.cmd" somehex.asm somehex.obj || goto :err
call "%ROOT%\fasm2.cmd" u8_as_hex_avx512.asm u8_as_hex_avx512.obj || goto :err
...
if /i "%MODE%"=="dispatch" (
  ...
  call "%ROOT%\fasm2.cmd" dispatch.asm dispatch.obj || goto :err
  call "%ROOT%\fasm2.cmd" hexer.asm hexer.obj || goto :err
  ...
  call "%ROOT%\fasm2.cmd" -i"HEXER_ISA='%MODE%'" hexer.asm hexer.obj || goto :err
)

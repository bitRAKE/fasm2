; 11_caption_fade.asm - animate caption-control state transitions.
;
; This keeps 09 child-HWND caption policy and gives the caption-state rows a
; timer-driven fade between normal, hover, pressed, and inactive visual states.

ADDON_WINDOWS_RESOURCE equ '11_caption_fade.res'
...
macro csd_data
	app_name	du 'CSD 11 - caption fade',0
	class_name	du 'Fasm2CsdCaptionFade',0
	title_text	du '11  Timer-driven caption fade',0
	body_text	du 'This version keeps the embedded Search child HWND and animates caption button hover, press, and inactive transitions.',13,10,13,10
			du 'The timer advances compact caption-state rows while the Search edit remains HTCLIENT and open caption space remains HTCAPTION.',0
	status_format	du 'Caption fades use WM_TIMER | edit HWND %p | snap %s',0

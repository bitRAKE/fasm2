; 09_embed_edit.asm - host a live EDIT control in the caption.
;
; This keeps 08 snap-layout policy and promotes the Search descriptor slot into
; a child EDIT HWND. The edit owns focus, text input, and IME while surrounding
; caption space remains HTCAPTION.

ADDON_WINDOWS_RESOURCE equ '09_embed_edit.res'
...
macro csd_data
	app_name	du 'CSD 09 - embedded edit',0
	class_name	du 'Fasm2CsdEmbedEdit',0
	title_text	du '09  Embedded caption edit',0
	body_text	du 'This version keeps 08 snap-layout policy and turns the Search caption slot into a real EDIT child window.',13,10,13,10
			du 'The edit rectangle remains HTCLIENT and owns focus, text input, and IME. The surrounding open caption strip still returns HTCAPTION for native move and snap.',0
	status_format	du 'Caption edit HWND %p | snap %s',0
